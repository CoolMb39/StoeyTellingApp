...
export default class StoryScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      likes: this.props.route.params.story.story.likes, is_liked: false
...
const styles = StyleSheet.create({
  ...
  likeButtonLiked: {
    flexDirection: "row", width: RFValue(160), height: RFValue(40),
    justifyContent: "center",
    alignItems: "center",
    backgroundColor: "#eb3948",
    borderRadius: RFValue(30)
    ...
    flexDirection: "row",
    width: RFValue(160), height: RFValue(40), justifyContent: "center",
    alignItems: "center", borderColor: "#eb3948", borderRadius: RFValue(30), borderWidth: 2
  },
